...
insert  into `paquete`(`ID_PAQUETE`,`ID_TIPO_PAQUETE_NAC`,`ID_TIPO_PAQUETE_INT`,`NOMBRE_PAQUETE`,`DESCRIPCION_SERVICIOS`,`FECHA_INICIO`,`FECHA_FINAL`,`USR_REGISTRO`,`FEC_REGISTRO`,`USR_MODIFICACION`,`FEC_MODIFICACION`) values (24,29,NULL,'22','sdafsdafsdnfklsdjfkdjafkljdklafjsdkljfklsdjfkldsjaflakdsjfklsdajflkd kfljdaklfjdklafjdslañfjldkajfdklsjfkldsajfdklasjf kjfkldjaflkadjflkadsjflkdjfkdlsjfkdlsjf ksfjsdklafjsdklfajsdlakfjsdklfj lakfjsdlakfjasdklfjkldasfjsdklafj ljfdlakfjdklfjdakñlfj klfjdlkafj','2013-07-01 00:00:00','2013-07-18 00:00:00','admin','2013-07-01 14:40:36','admin','2013-07-01 14:44:34');
...
CREATE TABLE `reservacion` (
  ...
  `NUM_CONFIRMACION` varchar(6) NOT NULL,
  ...
  `USR_MODIFICACION` varchar(50) DEFAULT NULL,
  `FEC_MODIFICACION` datetime DEFAULT NULL,
  `ID_TIPO_PAQUETE_RESERVACION` int(11) NOT NULL,
  ...
  KEY `FK_reservacion` (`ID_TIPO_PAQUETE_RESERVACION`),
  ...
  CONSTRAINT `FK_reservacion` FOREIGN KEY (`ID_TIPO_PAQUETE_RESERVACION`) REFERENCES `tipo_paquete_reservacion` (`ID_TIPO_PAQUETE_RESERVACION`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert  into `tarifa_paquete`(`ID_TARIFA_PAQUETE`,`CANT_ADULTO_NAC`,`CANT_ADULTO_INT`,`CANT_NINIO_NAC`,`CANT_NINIO_INT`,`MONTO_ADULTO_NAC`,`MONTO_ADULTO_INT`,`MONTO_NINIO_NAC`,`MONTO_NINIO_INT`,`USR_REGISTRO`,`FEC_REGISTRO`,`USR_MODIFICACION`,`FEC_MODIFICACION`) values (10,2,1,NULL,NULL,'255.00','350.00',NULL,NULL,'admin','2013-07-01 14:40:36','admin','2013-07-01 14:44:34');
...
insert  into `tipo_paquete_nac`(`ID_TIPO_PAQUETE_NAC`,`ID_TARIFA_PAQUETE`,`ID_TARIFA_HABITACION`,`TIPO_TARIFA`,`DESCRIPCION_SERVICIOS`,`HOTEL`,`OBSERVACIONES`,`USR_REGISTRO`,`FEC_REGISTRO`,`USR_MODIFICACION`,`FEC_MODIFICACION`) values (29,10,NULL,'Personas',NULL,'2','22','admin','2013-07-01 14:40:36','admin','2013-07-01 14:44:34');

/*Table structure for table `tipo_paquete_reservacion` */

DROP TABLE IF EXISTS `tipo_paquete_reservacion`;

CREATE TABLE `tipo_paquete_reservacion` (
  `ID_TIPO_PAQUETE_RESERVACION` int(11) NOT NULL AUTO_INCREMENT,
  `TIPO_TARIFA` varchar(25) NOT NULL,
  `DESCRIPCION_SERVICIOS` varchar(1000) DEFAULT NULL,
  `HOTEL` varchar(100) DEFAULT NULL,
  `OBSERVACIONES` varchar(1000) DEFAULT NULL,
  ...
  `USR_MODIFICACION` varchar(50) DEFAULT NULL,
  `FEC_MODIFICACION` datetime DEFAULT NULL,
  PRIMARY KEY (`ID_TIPO_PAQUETE_RESERVACION`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `tipo_paquete_reservacion` */
