...
CREATE TABLE `tipo_paquete_int` (
  ...
  `IND_LOCALIDAD` char(1) NOT NULL,
  `INT_TIPO_VEHICULO` char(1) DEFAULT NULL,
  `IND_TIPO_TRASLADO` char(1) DEFAULT NULL,
...
CREATE TABLE `tipo_paquete_nac` (
  ...
  `ID_TARIFA_PAQUETE` decimal(8,0) DEFAULT NULL,
  `IND_TIPO_PAQUETE` char(1) NOT NULL,
  `IND_TIPO_HABITACION` char(1) DEFAULT NULL,
...
insert  into `usuario`(`ID_USUARIO`,`NOMBRE`,`PRIMER_APELLIDO`,`SEGUNDO_APELLIDO`,`EMAIL`,`PASSWORD`,`IND_TIPO`,`TELEFONO`,`USR_REGISTRO`,`FEC_REGISTRO`,`USR_MODIFICACION`,`FEC_MODIFICACION`) values ('1','Usuario','Usuario','Usuario','prueba','1','A','test','test','2013-05-22 00:00:00',NULL,NULL);
